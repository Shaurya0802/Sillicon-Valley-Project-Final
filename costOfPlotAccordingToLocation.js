...
function draw(){
    ...
    text35.position(displayWidth/2-300,displayHeight/2+6430);
    ...
    text2.position(200,displayHeight/2+6500);
    text2.style("font-family","Courier New");
    text2.style("textDecoration","underline");

    button.position(650,displayHeight/2+6515);
    ...
    button2.position(830,displayHeight/2+6515);
    ...
    button3.position(1010,displayHeight/2+6515);
    ...
    button.mousePressed(()=>{
        ...
        text34.position(displayWidth/2-280,displayHeight/2+6560);
        text34.style("font-family","Courier New");
        text34.style("textDecoration","underline");

        input.position(displayWidth/2+90,displayHeight/2+6580);
        input.style("font-family","Comic Sans MS");
        input.style("background-color","#cd00cd");
        input.style("color","#000000");

        button4.position(displayWidth/2-150,displayHeight/2+6610);
        ...
        button4.mousePressed(()=>{
            if(input.value()){
                ...
                text36.position(displayWidth/2-350,displayHeight/2+6660);
                ...
                text37.position(displayWidth/2-170,displayHeight/2+6680);
                ...
                text45.position(displayWidth/2-150,displayHeight/2+6820);
                ...
                text46.position(displayWidth/2-150,displayHeight/2+ 6860);
